...
from send_and_expire.upload.api.viewsets import UploadViewSet, DownloadViewSet, DeleteViewSet, ListUploadViewSet
...
router.register("lists", ListUploadViewSet, basename="list")
